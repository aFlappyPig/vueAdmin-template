    ...
    <el-row type="flex" justify="space-around">
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="投资组合" prop="portfolioSecu">
          <el-select v-model.trim="form.portfolioSecu" placeholder="请选择" @change="portfolioChange">
            <el-option
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="会计分类" prop="fAccountingType">
          <el-select v-model.trim="form.fAccountingType" placeholder="请选择" :disabled="!form.portfolioSecu">
            <el-option
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="交易员" prop="fExecutor">
          <el-select v-model.trim="form.fExecutor" placeholder="请选择" :disabled="!form.portfolioSecu" clearable>
            <el-option
    ...
    <el-row type="flex" justify="space-around">
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="交易对手" prop="fCounterpartyId">
          <el-select v-model.trim="form.fCounterpartyId" placeholder="请选择" @change="fCounterpartyIdChange">
            <el-option
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="对手交易员" prop="fCpTrader">
          <el-select v-model.trim="form.fCpTrader" placeholder="请选择" :disabled="!form.fCounterpartyId" clearable>
            <el-option
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="资金账户" prop="fCpCashacc">
          <el-select v-model.trim="form.fCpCashacc" placeholder="请选择" :disabled="!form.fCounterpartyId" clearable>
            <el-option
    ...
    <el-row type="flex" justify="space-around">
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="执行市场" prop="execution">
          <el-select v-model.trim="form.execution" placeholder="请选择" @change="executionChange">
            <el-option
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="报价类型" prop="fQuoteType">
          <el-select v-model.trim="form.fQuoteType" placeholder="请选择">
            <el-option
    ...
    <el-row type="flex" justify="space-around">
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="交易方向" prop="fTradeDirection">
          <el-select v-model.trim="form.fTradeDirection" placeholder="请选择">
            <el-option
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="债券面额(万元)" prop="trdParValue">
          <el-input
            placeholder="请输入内容"
            v-model.trim="form.trdParValue"
            :disabled="false">
          </el-input>
          <!--<number-format-fixed v-model="form.trdParValue" fixed="0"></number-format-fixed>-->
        </el-form-item>
      </el-col>
    </el-row>
    <el-row type="flex" justify="space-around">
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="清算速度" prop="fSettleSpeed">
          <el-radio-group v-model.trim="form.fSettleSpeed" @change="fSettleDateChange">
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="到期收益率(%)" prop="trdYtm">
          <el-input
            :disabled="!form.bond || !form.trdParValue"
            placeholder="请输入内容"
            @blur="calcByBond(1)"
            v-model.trim="form.trdYtm">
          </el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row type="flex" justify="space-around">
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="全价(元)" prop="trdFullPrice">
          <el-input
            placeholder="请输入内容"
            v-model.trim="form.trdFullPrice"
            @blur="calcByBond(3)"
            :disabled="!form.bond || !form.trdParValue">
          </el-input>
        </el-form-item>
    ...
    <el-row type="flex" justify="space-around">
      ...
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="结算金额(元)" prop="trdSettleAmount">
          <el-input
            placeholder="请输入内容"
            v-model.trim="form.trdSettleAmount"
            :disabled="true">
          </el-input>
        </el-form-item>
      </el-col>
      <el-col :lg="8" :md="6" :sm="6" :xs="6">
        <el-form-item label="行权收益率(%)" prop="trdExerciseYield">
          <el-input
            placeholder="请输入内容"
            v-model.trim="form.trdExerciseYield">
          </el-input>
        </el-form-item>
      </el-col>
    </el-row>
...
<script>
  ...
  import * as api from '@/api/instruction/bond'
